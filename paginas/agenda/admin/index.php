        ...
        <section class="principal px-4 pt-4" namespace="PRINCIPAL">
                    ...
                    <div class="w-100">
                        ...
                        <div class="d-flex justify-content-between w-100 mt-3">
                            ...
                            <div class="w-50 ms-3">
                                ...
                                <input class="form-control" type="date" name="fIngreso" id="fIngreso" autocomplete="off"
                                    required>
                            </div>
                            <div class="w-50 ms-3">
                                <label for="">EPS</label>
                                <input class="form-control" type="text" name="eps" id="eps" autocomplete="off" required>
                            </div>
                            <div class="w-50 ms-3">
                        ...
                        <div class="d-flex justify-content-between w-100 mt-3">
                            <div class="w-50">
                                ...
                                <select class="form-select" name="acudiente" id="acudiente">
                                    <?php include_once('../../../modelo/acudiente.php'); ?>
                                </select>
                            </div>
                            <div class="w-50 ms-3">
                                <label for="">Nombre de padre</label>
                                <input class="form-control" type="text" name="nomPadre" id="nomPadre" autocomplete="off"
                                    required>
                            </div>
                            <div class="w-50 ms-3">
                                <label for="">Nombre de madre</label>
                                <input class="form-control" type="text" name="nomMadre" id="nomMadre" autocomplete="off"
                                    required>
                            </div>
                            <div class="w-50 ms-3">
                                <label for="">Grupo</label>
                                <select class="form-select" name="grupo" id="grupo">
                                    <?php include_once('funciones/grupo.php'); ?>
                                </select>
                            </div>
                        </div>
                        <div class="my-3 d-flex justify-content-center">
                            <button class="btn btn-success me-3" onclick="registroEstudiante()">Enviar</button>
                            <button class="btn btn-danger" onclick="limpiarEstudiante()">Limpiar</button>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php include_once('funciones/estudiante.php'); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="d-flex justify-content-between w-100">
                                <div class="w-50">
                                    <label for="">Nombre del estudiante</label>
                                    <input class="form-control" type="text" name="nombreModal" id="nombreModal" autocomplete="off"
                                        required>
                                </div>
                                <div class="w-50 ms-3">
                                    <label for="">Documento del estudiante</label>
                            ...
                            <div class="d-flex justify-content-between w-100 mt-3">
                                ...
                                <div class="w-50 ms-3">
                                    <label for="">Fecha de ingreso</label>
                                    <input class="form-control" type="date" name="fIngresoModal" id="fIngresoModal"
                                        autocomplete="off" required>
                                </div>
                                <div class="w-50 ms-3">
                                    <label for="">EPS</label>
                                    <input class="form-control" type="text" name="epsModal" id="epsModal" autocomplete="off"
                                        required>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between w-100 mt-3">
                                <div class="w-50">
                                    <label for="">Acudiente</label>
                                    <select class="form-select" name="acudienteModal" id="acudienteModal">
                                        <?php include('../../../modelo/acudiente.php'); ?>
                                    </select>
                                </div>
                                <div class="w-50 ms-3">
                                    <label for="">Nombre de padre</label>
                                    <input class="form-control" type="text" name="nomPadreModal" id="nomPadreModal"
                                        autocomplete="off" required>
                                </div>
                                <div class="w-50 ms-3">
                                    <label for="">Nombre de madre</label>
                                    <input class="form-control" type="text" name="nomMadreModal" id="nomMadreModal"
                                        autocomplete="off" required>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between w-100 mt-3">
                                ...
                                <div class="w-50 ms-3">
                                    <label for="">Dirección de residencia</label>
                                    <input class="form-control" type="text" name="direccionModal" id="direccionModal"
                                        autocomplete="off" required>
                                </div>
                                <div class="w-50 ms-3">
                                    <label for="">Grupo</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" class="enviarActualizacion btn btn-primary" onclick="enviarActualizacionEstudiante(this.id)">Actualizar</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="eliminar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Eliminar estudiante</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" class="eliminarEstudiante btn btn-danger" onclick="eliminarEstudiante(this.id)">Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
